...
const Contact = ({isDarkMode}) => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "5fdfd2bc-257d-4a63-bbc7-cec85cdda6ec");
  ...
  return (
    <div id='contact' className='w-full px-6 sm:px-12 py-16 scroll-mt-20 bg-no-repeat bg-center 'style={{ 
        backgroundImage: isDarkMode? 'none':'url("/footer-bg-color.png") ',
        backgroundSize: isDarkMode? 'initial':'90% auto'
      }}>
       <h4 className='text-center mb-2 text-lg font-Ovo'>Connect with me</h4>
       <h2 className='text-center text-5xl font-Ovo'>Get in touch</h2>

       <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I'd love to hear from you! If you have any questions, comments, or feedbacks, please use the form below .</p>
       ...
       <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        <button type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>Submit now <Image src={assets.right_arrow_white} alt='' /></button>
